    ...
    return (
        <div className="flex flex-col items-center justify-end p-8 bg-gray-100 border-t border-gray-300 space-y-4 min-h-[150px] w-full bottom-0 left-0">
            <div className="flex space-x-4">
                <Link href="https://www.facebook.com/sjsumsa" target="_blank" aria-label="Facebook" className="text-blue-600 hover:text-blue-800">
                    {/* Facebook Icon */}
                ...
                <Link href="https://www.instagram.com/sjsumsa" target="_blank" aria-label="Instagram" className="text-pink-500 hover:text-pink-700">
                    {/* Instagram Icon */}
